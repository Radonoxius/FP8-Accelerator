...
fn main() {
    ...
    for i in 0..rx.capacity() {
        rx.push(
            [
                divide(&ax[i][0].into(), &bx[i][0].into()).0.into(),
                divide(&ax[i][1].into(), &bx[i][1].into()).0.into(),
                divide(&ax[i][2].into(), &bx[i][2].into()).0.into(),
                divide(&ax[i][3].into(), &bx[i][3].into()).0.into(),
                divide(&ax[i][4].into(), &bx[i][4].into()).0.into(),
                divide(&ax[i][5].into(), &bx[i][5].into()).0.into(),
                divide(&ax[i][6].into(), &bx[i][6].into()).0.into(),
                divide(&ax[i][7].into(), &bx[i][7].into()).0.into(),
                0.into(),
                0.into(),
                0.into(),
                0.into(),
